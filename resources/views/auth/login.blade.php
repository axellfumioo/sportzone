        ...
        <form action="" method="POST" class="w-full max-w-md space-y-6">
            ...
            <div class="flex justify-between items-center text-sm text-gray-600">
                <label class="flex items-center space-x-2">
                    <input type="checkbox" name="remember" class="accent-[#C5383C]">
                    <span>Ingat saya</span>
                </label>
                <a href="" class="text-[#C5383C] hover:underline font-medium">Lupa password?</a>
            </div>
            ...
            <p class="text-center text-sm text-gray-600">
                Belum punya akun? <a href="/register" class="text-[#C5383C] hover:underline font-medium">Daftar di sini</a>
            </p>
        </form>
    </div>
</div>
